...
import com.demo.admindemo.config.core.ApplicationContextProvider;
    ...
    public BaseException build() {
        ...
        if (exceptionType.equals(NotFoundException.class)) {
            ...
            be = new InterfaceException(this.systemMessage,
                        ...
                        this.writableStackTrace,
                        this.userMessage);
        } else if (exceptionType.equals(JobConflictException.class)) {
            be = new JobConflictException(this.systemMessage,
                    this.cause,
                    this.enableSuppression,
                    this.writableStackTrace,
                    this.userMessage);
